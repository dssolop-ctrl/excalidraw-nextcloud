...
// Register "Новый холст" in Files app "+" menu via NC global state.
// NC's @nextcloud/files stores new menu entries in window._nc_newfilemenu
if (!window._nc_newfilemenu) {
  window._nc_newfilemenu = []
}
window._nc_newfilemenu.push({
